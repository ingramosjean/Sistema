...
<body>
  <?php include "include/header.php";?>
	...
	<h1>Motocicletas</h1></div><br>
<div class='table-responsive'>
<div style="overflow-x:scroll;">
<table class="table  table-hover table-striped" style="font-size:18px">
<tr><th>Imagen</th><th>Nombre</th><th>Precio</th></tr>
<?php
	$q = "SELECT Imagen FROM producto WHERE Categoria='MOTOS'";
	$result = mysqli_query($con,$q) or die ("Error al consultar");
	$img = mysqli_fetch_assoc($result);
	$products = $con->query("select Id,Nombre,Precio from producto where Categoria='MOTOS'");
