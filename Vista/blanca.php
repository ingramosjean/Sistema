...
$q = "SELECT Imagen FROM producto WHERE Categoria='LINEA BLANCA'";
...
<?php
$products = $con->query("select * from producto where Categoria='LINEA BLANCA'");
?>
...
<tr>
	...
	<?php else:?>
	<form class="form-inline" method="post" action="../Controlador/acarritoblanca.php">
